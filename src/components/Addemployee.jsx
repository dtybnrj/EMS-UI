    ...
    <div className='flex max-w-2xl mx-auto shabdow border-b'>
        <div className='px-8 py-8'>
            ...
            <div className='items-center justify-center h-14 w-full my-4 space-x-4 pt-4'>
                <button className='rounded text-white font-semibold bg-green-400 hover:bg-green-700 py-6 px-6' onClick={saveEmployee}>Save</button>
                <button className='rounded text-white font-semibold bg-red-400 hover:bg-red-700 py-6 px-6' onClick={reset}>Clear</button>
            </div>
        </div>
